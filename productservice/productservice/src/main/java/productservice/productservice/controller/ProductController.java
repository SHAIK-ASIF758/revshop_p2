...
//    private SellerService sellerService;
	...
	public String showProduct(@PathVariable Long id, Model model) {
		...
		String reviewUrl="http://localhost:9988/order/reviewController" + "?id=" + id;
	...
	public String searchProducts(@RequestParam("keyword") String keyword, Model model, HttpServletRequest request) {
		...
		if (buyerId != null) {
			...
			for (Product product : products) {
				try {
					String productServiceUrl = "http://localhost:9988/cart/productController/" + product.getProductId();
...
//        // Save the product
		...
		return "redirect:http://localhost:9988/seller/SellerDashboard";
	}
